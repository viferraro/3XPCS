...
import {
    Button, Box, TextField, Avatar, Typography,
    Snackbar, Alert, AlertTitle, Backdrop, CircularProgress
} from '@mui/material';
...
const CadastroPage = () => {
    ...
    const attCadastroUsuario = () => {
        ...
        Axios.put("http://localhost:1003/api/usuarios/" + document.getElementById("email").value, {
            ...
            if (response.status === 201) {
                ...
                if (locationState.admin === "true") {
                    ...
                    Axios.put("http://localhost:1003/api/usuarios/" + document.getElementById("email").value + "/status", {
                        status: 4
                    }).then(resposta2 => {
            ...
            <ThemeProvider theme={MuiEstilosPersonalizados}>
                <div className={jaCarregou ? "container-form" : "ocultar"} style={{ backgroundColor: 'var(--nvClaroFundo)' }}>
                    <div className="perfil">
                        <Avatar alt={"img_" + locationState.usuario.nome} src={locationState.usuario.urlImagem} referrerPolicy="no-referrer" />
