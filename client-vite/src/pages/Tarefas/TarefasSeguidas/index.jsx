...
const TarefasSeguidas = () => {
    ...
    const getTarefasSeguidos = (email) => {
        Axios.get("http://localhost:1003/api/usuarios/" + email + "/tarefa/seguidas").then(
            response => {
                ...
                response.data.forEach(elemento => {
                    const { nomeTarefa, descricao, nomeIteracao,
                        nomeProjeto, nomeUsuarioResp, status } = elemento;
