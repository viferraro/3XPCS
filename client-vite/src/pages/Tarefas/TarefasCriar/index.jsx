...
import {
    ...
    TextField, CssBaseline, Select, MenuItem, Autocomplete
} from "@mui/material";
...
const CriarTarefaPage = () => {
    ...
    const criarTarefa = () => {
        ...
        if (vrfUsuarioProjeto === true) {
            Axios.post("http://localhost:1003/api/tarefas", {
            ...
            <div className="nova-tarefa">
                ...
                <div className="principal-nova-tarefa">
                    <ThemeProvider theme={MuiEstilosPersonalizados}>
                        <Typography className="nome-acao"
                        ...
                        <Container sx={{ height: '100%' }} maxWidth="md">
                            <Box className="boxNovoTime"
                                ...
                                <Container sx={{ display: 'flex' }} className="containerDados container-projetos-tarefas">
                                    <Typography variant="body" component="h5" gutterBottom>
                                        Projetos:
                                    </Typography>
                                    {/* <Autocomplete
                                ...
                                <Container className="containerSalvar" sx={{ display: 'flex' }}>
                                    <Button color="success" variant="contained" onClick={criarTarefa} sx={{ width: '20%' }} >
                                        Salvar
                                    </Button>
                                </Container>
                            </Box>
