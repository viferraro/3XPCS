...
//Imports da MUI
import {
    Button, Grow, Container, Grid, CssBaseline,
    Typography, Card, Link, CardHeader, Avatar
} from '@mui/material';
...
const UsuarioSeguidos = () => {
    ...
    const buscarUsuariosSeguidos = (email) => {
        Axios.get("http://localhost:1003/api/usuarios/" + email + "/seguidos").then(
            response => {
            ...
            <ThemeProvider theme={MuiEstilosPersonalizados}>
                <div className="divMeio">
                    ...
                    <Typography
                        ...
                        sx={{
                            display: 'flex', marginTop: '0', marginBottom: '1em',
                            fontSize: '1.5rem', padding: '1% 2% 0 2%',
                            borderTopLeftRadius: '0.8rem', borderTopRightRadius: '0.8rem', color: 'fundoCard'
                        }}
                    >
                        Usuarios seguidos
                    </Typography>
                                            ...
                                            >
                                                <Card sx={{
                                                    ...
                                                    <CardHeader
                                                        avatar={
                                                            <Avatar
                                                                src={usuario.hasOwnProperty('urlImagem') ? usuario.urlImagem : "A"}
