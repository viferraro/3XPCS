...
//Imports da MUI
import {
    Button, Box, TextField, FormControlLabel, Checkbox, CssBaseline,
    Snackbar, Alert, AlertTitle, Container, Typography
} from '@mui/material';
                ...
                response => {
                    ...
                    if (response.data.hasOwnProperty('message')) {
                        if (response.data.message === "Usuário não encontrado") {
                            Axios.post("http://localhost:1003/api/usuarios", {
                                email: document.getElementById("email").value,
                                nome: document.getElementById("nome").value,
                                status: eAdmin ? 2 : 1, //Se for selecionado no checkbox admin, defina o status como 2, senão, defina como 1 
                            }).then(response => {
                                setSair(true);
                                setMensagem((document.getElementById("nome").value ?? 'Usuário ') + " autorizada com sucesso!");
                            }
                            );
                        }
                    }
                    ...
                    <Container disableGutters className={"principalAlteraUsuario"} sx={{ display: 'flex', paddingTop: '0' }}>
                        ...
                        <Box className="boxNovoTime"
                            sx={{
                                ...
                                alignItems: 'stretch', borderRadius: '15px', padding: '5vh 0 5vh 0', width: '100%',
                                marginTop: '0'
                            }}
                        ...
                        >
                            ...
                            <Container maxWidth="sm">
                                ...
                                >
                                    ...
                                    />
                                    <Button sx={{ width: '150px' }} variant="contained" color="success" startIcon={<FaUserShield />}
