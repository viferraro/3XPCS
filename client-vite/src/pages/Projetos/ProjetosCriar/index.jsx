...
import {
    ...
    TextField, CssBaseline, Select, MenuItem,
    Snackbar, Alert, AlertTitle, Chip, Autocomplete
} from "@mui/material";
...
const ProjetosCriar = () => {
    ...
    const criarProjeto = () => {
        ...
        if (listaIteracoes.length === 0) {
            ...
            Axios.post("http://localhost:1003/api/projetos", {
                ...
                .then((respostaCriaTime) => {
                    ...
                    setMensagem(document.getElementById('nome-projeto').value + " criado com sucesso!");
                    setSaiDaPagina(true)
                    setSair(true);
                });
        }
    ...
    const criarIteracao = (nome, descricao, dtInicio, dtFim) => {
        setListaIteracoes([...listaIteracoes, { nome: nome, descricao: descricao, dtInicio: dtInicio, dtFim: dtFim }]);
        setSaiItera(false);
    }
                    ...
                    <ThemeProvider theme={MuiEstilosPersonalizados}>
                        ...
                        <Container sx={{ height: '100%' }} maxWidth="md">
                            ...
                            >
                                ...
                                <Container sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin:'0' }} maxWidth="md">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Autocomplete
                                            ...
                                            renderInput={(params) => <TextField {...params} label="Escolha um time ativo" variant="outlined" />}
                                ...
                                <Container className="containerSalvar" sx={{ display: 'flex' }}>
                                    <Button color="success" variant="contained" onClick={criarProjeto} sx={{ width: '20%' }} >
                                        Salvar
                                    </Button>
                                </Container>
                            </Box>
