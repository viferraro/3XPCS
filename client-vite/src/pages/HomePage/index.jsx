...
import { Card, CardContent, Link, Typography, Backdrop, CircularProgress } from "@mui/material";
...
const HomePage = () => {
    ...
    const getDashboard = (email, admin) => {
        Axios.get("http://localhost:1003/api/usuarios/" + email + "/dashboard/" + admin).then(
            response => {
    ...
    // ! Função para levar o usuario logado a pagina de alterar usuario
    const irProjetos = () => {
        redirect("/projetos", { state: { usuario: locationState.usuario, admin: locationState.admin } })
    }
    ...
    // ! Função para levar o usuario logado a pagina de usuarios
    const irUsuarios = () => {
        redirect("/usuarios-adm", { state: { usuario: locationState.usuario, admin: locationState.admin } })
    }

    // ! 
    const irTarefasADM = () => {
        redirect("/tarefas/adm", { state: { usuario: locationState.usuario, admin: locationState.admin } })
    }
            ...
            <div className={jaCarregou ? "principal" : "ocultar"}>
                <ThemeProvider theme={MuiEstilosPersonalizados}>
                    <Card sx={{
                        ...
                        className='cards' variant="outline">
                        <CardContent>
                            ...
                            >
                                Você está em <Link sx={{
                                    ...
                                    {dashboard.qtdTimesUsuario}</Link> times.
                            </Typography>
                            ...
                            >
                                Há um total de <Link underline="none"
                                    sx={{
                                        cursor: 'pointer',
                                        backgroundColor: 'fundoCard',
                                        color: 'black',
                                    ...
                                    {dashboard.qtdTimesSys} </Link> times ativos.
                            </Typography>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent>
                            ...
                            >
                                Você está em <Link sx={{
                                    ...
                                    {dashboard.qtdProjetosUsuario}</Link> projetos.
                            </Typography>
                            ...
                            >
                                Há um total de <Link sx={{
                                    ...
                                    {dashboard.qtdProjetosSys} </Link> projetos ativos.
                            </Typography>
                        </CardContent>
                    </Card>
                    ...
                    <Card sx={{
                        ...
                        <CardContent>
                            ...
                            <Typography
                                sx={{ mb: 1, fontWeight: '500', display: dashboard.qtdTarefas === "" ? 'none' : '' }}
                                color="texto.descricao"
                            >
                                <Link sx={{
                                    textDecoration: 'none',
                                    ...
                                    {dashboard.qtdTarefas}</Link> tarefas pendentes.
                            </Typography>

                            <Typography
                                sx={{ mb: 1, fontWeight: '500', display: dashboard.qtdTarefasSemana === "" ? 'none' : '' }}
                                color="texto.descricao"
                            ...
                            >
                                <Link sx={{
                                    ...
                                    {dashboard.qtdTarefasSemana} </Link> tarefas vencem esta semana.
                            </Typography>
                            <Typography
                                sx={{ mb: 1, fontWeight: '500', display: dashboard.qtdTarefasSys === "" ? 'none' : '' }}
                                color="texto.descricao"
                            ...
                            >
                                Há um total de <Link sx={{
                                    ...
                                    {dashboard.qtdTarefasSys} </Link> tarefas em andamento no geral.
                            </Typography>
                        </CardContent>
                    </Card>
                    ...
                    <Card sx={{
                        ...
                        className={locationState.admin === "true" ? "cards" : "ocultar"} variant="outline">
                        <CardContent>
                            <Typography variant="h5"
                                gutterBottom
                                sx={{ fontWeight: '900' }} >
                            ...
                            >
                                Há <Link sx={{
                                    ...
                                    {dashboard.qtdUsuarios}</Link> usuários no sistema.
                            </Typography>
